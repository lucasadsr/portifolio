...
export const en: Dictionary = {
  ...
  githubStats: {
    sectionBadge: 'Open Source & Activity',
    sectionTitle: 'GitHub Metrics',
    sectionDescription:
      'Real-time data fetched directly from the GitHub API showing public projects, top language, and contributions.',
    liveIndicator: 'Live GitHub API Data',
    publicRepos: 'Public Repositories',
    publicReposSub: 'Published open-source projects',
    totalStars: 'Stargazers Count',
    totalStarsSub: 'Community recognition',
    topLanguage: 'Primary Language',
    topLanguageSub: 'Most active tech stack',
    yearsActive: 'GitHub Journey',
    yearsActiveSub: 'Years building on GitHub',
    yearsText: 'Years',
    totalPRs: 'Pull Requests Created',
    totalPRsSub: 'Contributions & features delivered in public repositories',
    pittayaStars: 'Pittaya UI Ecosystem',
    pittayaStarsSub: 'Stars on Pittaya UI Kit & UI',
    contributionTitle: 'Contribution Calendar',
    contributionSub: 'Public activity history over the last year',
    contributionTotalCount: '{{count}} contributions in the last year',
    contributionSingle: 'contribution on',
    contributionPlural: 'contributions on',
    visitProfile: 'View full GitHub profile',
  },
  projects: {
